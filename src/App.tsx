...
import JSONExportPage from './JSONExportPage';
    ...
    <nav style={{ display: 'flex', gap: 16, justifyContent: 'center', marginBottom: 32 }}>
      ...
      <Link
        ...
        style={{
          padding: '12px 32px',
          borderRadius: 12,
          background: location.pathname === '/json-export' ? '#1976d2' : '#f5f5f5',
          color: location.pathname === '/json-export' ? '#fff' : '#1976d2',
          fontWeight: 700,
          fontSize: 18,
          textDecoration: 'none',
          boxShadow: location.pathname === '/json-export' ? '0 2px 8px rgba(25,118,210,0.08)' : 'none',
          border: 'none',
          transition: 'all 0.2s',
        }}
      >
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/json-export" element={<JSONExportPage date={date} />} />
        </Routes>
      </div>
    </Router>
  );
